var commons = require("../commons.hot-update");
    ...
    viewportCases.forEach((data) => {
      describe(`Viewport: ${data.describe}`, function() {
        ...
        it("Navegates betwwen the lists", function() {
          ...
          cy.get("div.project-button-container.home-project-button-paintings").should(
            "have.class",
            "active",
          );
          cy.get("div.project-button-container.home-project-button-sculptures").should(
            "have.class",
            "no-active",
          );
          cy.get("div.project-button-container.home-project-button-architecture").should(
            "have.class",
            "no-active",
          );
